...
export function ProductCard({ product, index = 0 }: { product: Product; index?: number }) {
  ...
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-2xl bg-card shadow-soft transition-all duration-500 hover:shadow-luxury"
    >
      <Link to="/product/$id" params={{ id: product.id }} className="block">
        <div className="relative aspect-[3/4] overflow-hidden bg-secondary">
          ...
          <div className="absolute inset-x-0 bottom-0 translate-y-full bg-gradient-to-t from-[var(--maroon-deep)]/90 to-transparent p-4 text-primary-foreground transition-transform duration-500 group-hover:translate-y-0">
